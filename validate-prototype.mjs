...
await page.locator("#noticeSalesEntry").click();
const systemNoticeFloatToSalesTitle = await page.locator("#salesAppTitle").innerText();
const systemNoticeFloatToSalesCards = await page.locator("#salesAppView .sales-user-card").count();
...
console.log(JSON.stringify({
  ...
  systemNoticeFloatToSalesTitle,
  systemNoticeFloatToSalesCards,
